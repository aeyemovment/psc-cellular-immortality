...
**Run** `20260921T132605Z` · **tag** `muse_own` · **policy** `CUSP-SNPC-DA-RESILIENCE-001` · precursor `NA-PSC-IMM-001`
...
- O2 on, CI intact: ATP_end = 2.065 mM, collapsed = False
...
|-----|--------|----------|---------------|------------|----------|--------|-----|
| SNPC | WT | True | False | None | 0.2677 | 0.737 | mitophagy |
| SNPC | SNCA | False | False | 76 | 0.7969 | 0.4988 | mitophagy |
| SNPC | MPTP | False | False | 55 | 0.2892 | 0.1449 | mitophagy |
| SNPC | COMBINED | False | False | 55 | 0.8358 | 0.1143 | degenerating |
| VTA | WT | True | True | None | 0.078 | 0.7995 | pacemaker_ok |
| VTA | SNCA | True | True | None | 0.2086 | 0.756 | pacemaker_ok |
| VTA | MPTP | False | False | 71 | 0.1113 | 0.3027 | pacemaker_ok |
| VTA | COMBINED | False | False | 59 | 0.2867 | 0.1721 | pacemaker_ok |
| SNPC_TX | WT | True | True | None | 0.0519 | 0.8972 | survival_lock |
| SNPC_TX | SNCA | True | True | None | 0.2225 | 0.8111 | survival_lock |
| SNPC_TX | MPTP | True | False | None | 0.1164 | 0.4861 | mitophagy |
| SNPC_TX | COMBINED | False | False | 74 | 0.306 | 0.3429 | transplant_dock |
