...
**Run** `20260921T130059Z` · **tag** `astra_probe` · **policy** `CUSP-SNPC-DA-RESILIENCE-001` · precursor `NA-PSC-IMM-001`
...
|-----|--------|----------|---------------|------------|----------|--------|-----|
| SNPC | WT | True | False | None | 0.2456 | 0.7435 | mitophagy |
| SNPC | SNCA | False | False | 77 | 0.7787 | 0.5225 | mitophagy |
| SNPC | MPTP | False | False | 55 | 0.2761 | 0.1463 | mitophagy |
| SNPC | COMBINED | False | False | 55 | 0.7819 | 0.1176 | high_ca_stress |
| VTA | WT | True | True | None | 0.0809 | 0.8008 | pacemaker_ok |
| VTA | SNCA | True | True | None | 0.2257 | 0.7524 | pacemaker_ok |
| VTA | MPTP | False | False | 76 | 0.0837 | 0.3736 | pacemaker_ok |
| VTA | COMBINED | False | False | 63 | 0.2668 | 0.2042 | pacemaker_ok |
| SNPC_TX | WT | True | True | None | 0.061 | 0.8977 | survival_lock |
| SNPC_TX | SNCA | True | True | None | 0.2181 | 0.8174 | survival_lock |
| SNPC_TX | MPTP | True | False | None | 0.1114 | 0.4855 | mitophagy |
| SNPC_TX | COMBINED | False | False | 77 | 0.3077 | 0.3889 | transplant_dock |
